 ...
 */
module.exports.aggregateEntities = (start = 0, end = 9999999999999, limit = 100) =>
 ...
 */
module.exports.uploadArticlesFromDocs = docs => {
  ...
  docs.forEach(doc => {
    if (doc) {
      const articleAndEntitityPrimitives = _adaptFromAlchemyDoc(doc);
...
const _adaptFromAlchemyDoc = doc => {
